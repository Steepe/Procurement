...
================================================== */
	...
	$('.datatable-ajax-source table').dataTable({
        //ajax: 'http://localhost/procurement/assets/media/datatable_ajax_source.txt'
       // ajax: 'http://localhost/procurement/request/request_list'
	});
...
================================================== */
	...
	$(".multiple-uploader").pluploadQueue({
        ...
        //url : 'http://www.thispresenthouse.org/hofportal/procurement/uploader/do_upload',
		...
		filters : {
			max_file_size : '10mb',
			mime_types: [
				{title : "Image files", extensions : "jpg,gif,png,pdf,jpeg,doc,docx"},
